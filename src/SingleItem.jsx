...
function SingleItem({ handleAddMultiple, formatPrice }) {
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-[1fr_0.5fr_0.5fr] grid-rows-[20px_350px_100px] mx-20 mt-[210px] max-w-[830px] mx-auto">                
                <img className="col-span-1 object-contain row-span-4 h-[400px] justify-self-center pt-3" src={product.image} alt={product.title} />
                <div className="row-span-1 col-span-2 place-self-center pb-5">
                    <h1 className="mx-6 pt-10 pb-2 font-extrabold xs:text-[12px]">{product.title}</h1>
